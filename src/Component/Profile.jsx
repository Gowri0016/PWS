...
export default function AwsProfessionalDashboard() {
  ...
  {/* Sidebar */}
  <aside
    className={`transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 transition-transform duration-300 ease-in-out md:w-72 w-64 bg-black backdrop-blur border-r border-gray-200 min-h-screen p-4`}
  >
    {/* Logo */}
...
<div className="mt-auto pt-6 border-t border-gray-200 hidden md:block">
  ...
  <div className="mt-3 flex gap-2">
    <button
      ...
      className="text-xs px-3 py-2 rounded bg-black"
    >
      Profile
    </button>
    <button className="text-xs px-3 py-2 rounded bg-black border">
      Sign out
    </button>
  </div>
</div>
...
<main className="flex-1 p-6">
  ...
  <div className="flex items-center justify-between mb-6">
    ...
    <div className="flex items-center gap-3">
      <select
        ...
        className="px-3 py-2 rounded-lg bg-black border"
      >
        {regions.map((r) => (
      ...
      <button className="p-2 rounded-lg bg-black shadow-sm">
        <FaBell />
      </button>
      <button
        className="p-2 rounded-lg bg-black shadow-sm"
        onClick={() => setProfileOpen(true)}
      >
        <FaUserCircle />
      </button>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <motion.div
      ...
      className="col-span-1 md:col-span-2 lg:col-span-2 bg-black rounded-2xl p-5 shadow"
    >
...
<motion.div
  initial={{ opacity: 0, y: 8 }}
  animate={{ opacity: 1, y: 0 }}
  className="bg-black/35 border 2xl border-white rounded-2xl p-5 shadow col-span-1 md:col-span-1 lg:col-span-1"
>
  <div className="flex items-center justify-between mb-4">
    <div>
  ...
  <div className="mt-3 text-sm text-slate-600">
    Projected monthly spend: <span className="font-semibold">$1,420</span>
  </div>
  <div className="mt-4 flex flex-col md:flex-row gap-2">
    <button className="flex-1 py-2 rounded-lg bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 text-white">
      Pay Invoice
    </button>
